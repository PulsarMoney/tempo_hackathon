...
export function TopBar({ currentPrice, balance }: TopBarProps) {
  return (
    <div className="panel-shell flex items-center justify-between gap-3 px-4 py-3">
      <div className="flex items-center gap-3">
        <Badge variant="secondary" className="border-primary/35 bg-primary/12 text-blue-200">
          CHART / USD
        </Badge>
        ...
        <div className="flex items-center gap-1 text-xs text-blue-300/90">
